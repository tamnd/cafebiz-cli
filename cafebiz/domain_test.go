...
// HTTP behaviour is covered in cafebiz_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "cafebiz" {
		t.Errorf("Identity.Binary = %q, want cafebiz", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "cafebiz://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("cafebiz", "about")
	if err != nil || got.String() != "cafebiz://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want cafebiz://page/about", got.String(), err)
	}
}
